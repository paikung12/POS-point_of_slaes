<template>
<div>
    <svg height="100%" width="100%" id="svg" viewBox="0 0 1440 400" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150 -mt-28">
        <defs>
    ...
    <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4 -mt-96">
        <div class="flex flex-row justify-between items-center px-5  ">
            ...
            <div class="text-gray-800">
                <div class="font-bold text-3xl pl-5 text-white ">Summary of Today</div>
            ...
            <div class="flex flex-col flex-wrap sm:flex-row ">
                ...
                <div class="w-full sm:w-1/2 xl:w-3/4 pl-8" v-if="response">
                    ...
                    <div class="mb-4 mx-0 sm:ml-4 xl:mr-4">
                        <div v-if="response" class="shadow-lg rounded-2xl bg-white dark:bg-gray-700 w-full">
