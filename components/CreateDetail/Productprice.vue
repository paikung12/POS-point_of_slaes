            ...
            <div class="flex justify-between px-4 items-center">
                <div class="text-lg font-semibold">
                    ...
                    <div class="flex flex-row">
                        ...
                        <v-select v-model="form1.type" :items="product_types"
                        label="select" item-text="name" item-value="id" outlined></v-select>
                ...
                <div class="text-lg font-semibold">
                    <p class="text-blue-600">Product Price</p>
                        <v-row align="center">
                            ...
                            <v-col cols="12" sm="12">
                                <v-row>
                                    <v-select v-model="checkbox" :items="heat_levels"
                        label="select" item-text="name" item-value="id" outlined></v-select>

                         <v-text-field  label="price" v-model="price" 
                                         :key="index"  outlined dense multiple 
                                         
                                         ></v-text-field>
                        
                                    <button @click.prevent="addPrice(checkbox, price)">
    ...
    async created(){
     ...
     methods: {
         ...
         async addPrice(id, p) {
            ...
            console.log(data)
             this.prices.push({heat:id,name:data.name, price:p} )
