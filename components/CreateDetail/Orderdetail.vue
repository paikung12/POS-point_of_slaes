            ...
            <div class="flex justify-between px-4 items-center">
                <div class="text-lg font-semibold">
                    ...
                    <v-row align="center">
                        ...
                        <v-col cols="12" sm="6">
                            <v-text-field label="filled" v-model="form.name" outlined  multiple hint="Pick your favorite states"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6">
                        ...
                        <v-col cols="12" sm="6">
                            <div class="flex flex-wrap">
                                <div v-for="type,index in product_types" :key="index">
                                    <v-checkbox class="pl-5" v-model="form.type" :label="type.name" :value="type.id">
                                    </v-checkbox>
                                </div>
                            </div>
                        </v-col>
                        ...
                        <v-col cols="12" sm="6">
                            <v-text-field label="filled" v-model="form.price" outlined  multiple hint="Pick your favorite states"></v-text-field>
                        </v-col>
                    </v-row>
